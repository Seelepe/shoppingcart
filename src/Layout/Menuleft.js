    ...
    let get =  localStorage.getItem("isCheck")
      console.log(get)
        if(get){
          ...
          if (check1 ==true) {
            return(
              <div className="panel-group category-products" >{/*category-productsr*/}
                ...
                <div className="panel panel-default">
                  <div className="panel-heading">
                    <h4 className="panel-title">
                      <Link to="/Account/Myproducts"  data-toggle="collapse" data-parent="#accordian">
                        <span className="badge pull-right"><i className="fa fa-plus" /></span>
                        MY PRODUCTS
                      </Link>
                    </h4>
